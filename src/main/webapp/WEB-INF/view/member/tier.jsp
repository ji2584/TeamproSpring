						...
						<div class="item">
							...
							<p class="txt">
								<a href="${pageContext.request.contextPath}/member/tier" title="">나의등급</a> <a
									href="" title="${pageContext.request.contextPath}/member/memberinfo">회원정보 보기 / 수정</a> <a
				...
				<table class="revcoupon">
					...
					<tbody><tr>
						<td class="rc_mark"><img src="/images/integ/ab_new.png">
							<p>${amem.id} 님의 회원등급은 <strong>${Tier}</strong>입니다.</p>
					...
					<tr>
						<td colspan="2" class="rc_standard">KIC AUCTION 회원등급 / 산정기준</td>
					</tr>
					<tr>
