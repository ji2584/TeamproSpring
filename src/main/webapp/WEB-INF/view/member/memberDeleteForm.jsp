	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto text-center"> <!-- text-center 추가 -->
				<h2 class="mb-3" style="text-align:center">회원탈퇴</h2><p>
				<form class="validation-form" novalidate action="memberDeletePro">
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="id"></label>
							<input type="text" class="form-control" id="id" placeholder="ID" value="${id}" readonly name="id">
						</div><p>
						<div class="col-md-6 mb-3">
					...
					<div class="mb-1"></div>
					<button class="lo" type="submit">탈퇴</button>
				</form>
			</div>
		</div>
	</div>
