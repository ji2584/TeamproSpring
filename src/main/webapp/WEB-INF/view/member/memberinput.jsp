			...
			<form class="validation-form" novalidate action="memberPro" method="post" name="f">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <div>아이디</div> <input type="text"
                        class="form-control" id="sw" placeholder="" value="" required  name="id">
                    
                  
                     <div>이름</div><input type="text"
                        class="form-control" id="sw" placeholder="" value="" required  name="name">
                     ...
                     <div>비밀번호확인</div> <input type="password"
                        class="form-control" id="sw" placeholder="" value="" required  name="pass2">
                  
              
                     <div>전화번호</div> <input type="tel"
                        class="form-control" id="sw" placeholder="" value="" required  name="tel">
              
                    <div>은행명</div> <input type="text"
                        class="form-control" id="sw" placeholder="" value="" required  name="bank">
                   
             
                     <div>계좌번호</div><input type="text"
                        class="form-control" id="ssw" placeholder="" value=""   name="account"
                        required>
           
                     <div>이메일</div> <input type="text"
                        class="form-control" id="ssw" placeholder="" value="" required  name="email">
          
                    <div>주소</div> <input type="text"
                        class="form-control" id="ssw" placeholder="" value=""   name="address"
                        required>
